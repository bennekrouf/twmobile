var app = angular.module('nibs', ['ionic', 'openfb', 'nibs.config', 'nibs.shop', 'nibs.profile', 'nibs.auth', 'nibs.product', 'nibs.offer', 'nibs.store-locator', 'nibs.gallery', 'nibs.settings', 'nibs.case'])
